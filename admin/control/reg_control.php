...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $result = $db->insertAdminData($full_name, $username, $email, $hashed_password, $phone_number, $role, $employee_id, $address, $security_question, $profile_picture_path, $default_language, $time_zone);
